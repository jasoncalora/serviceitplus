...
<html lang="en">
<head>
	<title>Products | Service IT+</title>
...
<div class="partners-container">
    ...
    <div class="owl-carousel" data-aos="fade-up" data-aos-offset="100" data-aos-duration="1200" data-aos-once="true" data-aos-delay="300">
        <div class="client-logo"><img id="bomgar-logo" src="../images/products/logos/bomgar-logo2.png" alt=""></div>
        <div class="client-logo"><img id="cherwell-logo" src="../images/products/logos/cehrwell.jpg" alt=""></div>
        <div class="client-logo"><img id="hornbill-logo" src="../images/products/logos/hornbill-logo.png" alt=""></div>
        <div class="client-logo"><img id="ivanti-logo" src="../images/products/logos/ivanti.png" alt=""></div>
        <div class="client-logo"><img id="microfocus-logo" src="../images/products/logos/mf.jpg" alt=""></div>
    </div>
</div>
<!--------------------------------  PRODUCT LINES  ----------------------------------->
